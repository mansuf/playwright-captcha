...
async def solve_cloudflare_turnstile_solvertr(async_solvertr_client: AsyncSolverTr, **kwargs) -> dict:
    """
    Solve Cloudflare Turnstile captcha using Solver.tr service.
    ...
    logger.debug('Solving Cloudflare Turnstile captcha using Solver.tr...')
