...
async def solve_cloudflare_turnstile_capmonster(async_capmonster_client: AsyncCapMonster, **kwargs) -> dict:
    """
    Solve Cloudflare Turnstile captcha using CapMonster service.
    ...
    logger.debug('Solving Cloudflare Turnstile captcha using CapMonster...')
